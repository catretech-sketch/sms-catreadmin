...
type IcOpts = { fill?: string | boolean; sw?: number };

const Ic = (paths: React.ReactElement | (React.ReactElement | null)[], opts: IcOpts = {}) => (props: IconProps): React.ReactElement => {
...
const P = (d: string, extra?: object) => React.createElement('path', { d, ...(extra || {}) });
...
const R = (x: number, y: number, w: number, h: number, rx: number) => React.createElement('rect', { x, y, width: w, height: h, rx });
